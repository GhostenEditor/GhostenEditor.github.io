...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1635: (x0,x1) => x0.getItem(x1),
      _1637: (x0,x1,x2) => x0.setItem(x1,x2),
      ...
      _1710: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1711: () => new TextDecoder("utf-8", {fatal: true}),
      _1712: () => new TextDecoder("utf-8", {fatal: false}),
      _1713: x0 => new WeakRef(x0),
      _1714: x0 => x0.deref(),
      _1720: Date.now,
      _1721: secondsSinceEpoch => {
      ...
      _1722: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1723: s => {
      ...
      _1761: (a, i) => a.push(i),
      _1762: (a, i) => a.splice(i, 1)[0],
      _1764: (a, l) => a.length = l,
      _1765: a => a.pop(),
      _1766: (a, i) => a.splice(i, 1),
      _1768: (a, s) => a.join(s),
      _1769: (a, s, e) => a.slice(s, e),
      _1770: (a, s, e) => a.splice(s, e),
      ...
      _1789: (t, s) => t.set(s),
      _1790: l => new DataView(new ArrayBuffer(l)),
      ...
      _1839: x0 => x0.send(),
      _1841: x0 => x0.getAllResponseHeaders(),
      ...
      _1852: () => Date.now(),
      _1853: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1854: (x0,x1,x2) => x0.fetch(x1,x2),
      _1855: (x0,x1) => x0.get(x1),
      _1856: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1856(f,arguments.length,x0,x1,x2) }),
      _1857: (x0,x1) => x0.forEach(x1),
      _1859: () => new AbortController(),
      _1860: x0 => x0.getReader(),
      _1861: x0 => x0.read(),
      _1862: x0 => x0.cancel(),
      ...
      _2091: x0 => x0.readyState,
      _2093: (x0,x1) => x0.timeout = x1,
      _2095: (x0,x1) => x0.withCredentials = x1,
      _2096: x0 => x0.upload,
      _2097: x0 => x0.responseURL,
      _2098: x0 => x0.status,
      _2099: x0 => x0.statusText,
      _2101: (x0,x1) => x0.responseType = x1,
      _2102: x0 => x0.response,
      _2116: x0 => x0.loaded,
      _2117: x0 => x0.total,
      _3914: () => globalThis.window,
      _3978: x0 => x0.navigator,
      _4242: x0 => x0.localStorage,
      _4369: x0 => x0.userAgent,
      _4589: x0 => x0.length,
      _6616: x0 => x0.signal,
      _8520: x0 => x0.value,
      _8522: x0 => x0.done,
